...
* Hapi.Js - The best way to understand express is through its [Official Website](https://hapijs.com/).
...
### Cloning The Foodz Repository
The recommended way to get Foodz is to use git to directly clone the foodz repository:

```bash
$ git clone https://github.com/kaushiksamanta/Foodz.git
```
